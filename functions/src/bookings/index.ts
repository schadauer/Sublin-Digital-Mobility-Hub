    ...
    .onUpdate(async (change, context) => {
        try {
            ...
            if (after !== undefined && after.booked !== undefined && after.booked === true) {
                ...
                if (after.sublinEndStep !== undefined && after.sublinEndStep !== null && after.sublinEndStep.provider !== undefined && after.sublinEndStep.provider.id !== undefined && after.sublinEndStep.confirmed !== undefined && after.sublinEndStep.confirmed === false) {
                ...
                if (after.sublinStartStep !== undefined && after.sublinStartStep !== null && after.sublinStartStep.provider !== undefined && after.sublinStartStep.provider.id !== undefined && after.sublinStartStep.confirmed !== undefined && after.sublinStartStep.confirmed === false) {
